...
public class MyDBHandler extends SQLiteOpenHelper
{
    ...
    public void addUser(UserData userData)
    {
        ...
        value.put(COLUMN_USERNAME, userData.getMyUserName());
    ...
    public boolean deleteAccount(String userame)
    {
        boolean result = false;

        String query = "SELECT * FROM " + ACCOUNTS + " WHERE " + COLUMN_USERNAME + "= \"" + userame + "= \"";
